...
namespace Instrument_Spec_Manager.Module.Migrations
{
    ...
    [Migration("20240804123246_AddResumeAndPortfolio")]
    partial class AddResumeAndPortfolio
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Instrument_Spec_Manager.Module.BusinessObjects.Address", b =>
                {
                    b.Property<Guid>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Instrument_Spec_Manager.Module.BusinessObjects.DemoTask", b =>
                {
                    b.Property<Guid>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Instrument_Spec_Manager.Module.BusinessObjects.Note", b =>
                {
                    b.Property<Guid>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Instrument_Spec_Manager.Module.BusinessObjects.Payment", b =>
                {
                    b.Property<Guid>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Instrument_Spec_Manager.Module.BusinessObjects.PortfolioFileData", b =>
                {
                    b.Property<Guid>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Instrument_Spec_Manager.Module.BusinessObjects.Position", b =>
                {
                    b.Property<Guid>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Instrument_Spec_Manager.Module.BusinessObjects.Resume", b =>
                {
                    b.Property<Guid>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DemoTaskEmployee", b =>
                {
                    b.HasOne("Instrument_Spec_Manager.Module.BusinessObjects.DemoTask", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Instrument_Spec_Manager.Module.BusinessObjects.Employee", b =>
                {
                    b.HasOne("Instrument_Spec_Manager.Module.BusinessObjects.Address", "Address")
                        .WithMany()
                    ...
                    b.HasOne("Instrument_Spec_Manager.Module.BusinessObjects.Employee", "Manager")
                        .WithMany()
                        .HasForeignKey("ManagerID");

                    b.HasOne("Instrument_Spec_Manager.Module.BusinessObjects.Position", "Position")
                        .WithMany()
            ...
            modelBuilder.Entity("Instrument_Spec_Manager.Module.BusinessObjects.PortfolioFileData", b =>
                {
                    ...
                    b.HasOne("Instrument_Spec_Manager.Module.BusinessObjects.Resume", "Resume")
                        .WithMany("Portfolio")
            ...
            modelBuilder.Entity("Instrument_Spec_Manager.Module.BusinessObjects.Resume", b =>
                {
                    b.HasOne("Instrument_Spec_Manager.Module.BusinessObjects.Employee", "Employee")
                        .WithMany("Resumes")
                        .HasForeignKey("EmployeeID")
                        .OnDelete(DeleteBehavior.SetNull);
