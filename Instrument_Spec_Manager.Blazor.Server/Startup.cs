...
using Instrument_Spec_Manager.Blazor.Server.Services;
...
public class Startup {
    ...
    public void ConfigureServices(IServiceCollection services) {
        ...
        services.AddXaf(Configuration, builder => {
            builder.UseApplication<Instrument_Spec_ManagerBlazorApplication>();
            builder.Modules
            ...
            builder.Security
                .UseIntegratedMode(options => {
                    ...
                    options.UserType = typeof(Instrument_Spec_Manager.Module.BusinessObjects.ApplicationUser);
                    // ApplicationUserLoginInfo is only necessary for applications that use the ApplicationUser user type.
                    // If you use PermissionPolicyUser or a custom user type, comment out the following line:
                    options.UserLoginInfoType = typeof(Instrument_Spec_Manager.Module.BusinessObjects.ApplicationUserLoginInfo);
